message_pairs = (("Bravo_one","Bravo two, kggggt... come   in.  over."), ("Bravo_two", " Bravo one,  read you LOUD and cleAr.. kgggtttt..   over."), ("Bravo_one", " tEstIng MessAge Budget, ThinkIng About whaT to SaY iS Hard!  "), ("Bravo_two", " Here iS AnotheR MeSSage To  you bravo one..  Test TesT. "), ("Bravo_one", " TeSt tEst TeST TeSt tEst TeST TeSt tEst TeST TeSt tEst TeST TeSt tEst TeST TeSt tEst TeST "))
